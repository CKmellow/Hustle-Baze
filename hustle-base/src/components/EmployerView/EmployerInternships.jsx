...
const EmployerInternships = () => {
  ...
  const openCreateForm = () => {
    setIsEditing(false);
    setForm({ title: '', location: '', duration: '', stipend: '', description: '', requirements: '' });
    setShowForm(true);
  };
    ...
    <div className="internship-page">
      ...
      <div className="internship-grid">
        {internships.map((internship) => (
          <div className="internship-card" key={internship._id} onClick={() => setSelectedInternship(internship)}>
          ...
          <div className="internship-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <input
                ...
                name="stipend"
                value={form.stipend}
                placeholder="Stipend (e.g., Ksh 10,000)"
                onChange={handleChange}
                required
              />
              <textarea
